    ...
    <main>
      ...
      <header className={`site-header ${mobileMenuOpen ? "menu-open" : ""}`}>
        ...
        <div className="mobile-menu" id="mobile-menu">
          ...
          <div><span>10 setembro · Americana, SP</span></div>
        </div>
      </header>
      ...
      <footer><div className="brand footer-brand"><img src={BASILICA_CREST} alt="" /><span><strong>Basílica</strong><small>Santo Antônio</small></span></div><p>Arte pela Basílica · Edição 2026<br /><a href="https://commons.wikimedia.org/wiki/File:Air.ogg" target="_blank" rel="noreferrer">Áudio: Bach, Air · U.S. Air Force Band · domínio público</a></p><p>Acervo online até 17 de setembro</p></footer>
      </div>
