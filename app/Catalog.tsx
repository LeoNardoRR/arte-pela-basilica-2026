  ...
  return (
    <main>
      ...
      <section className="hero" id="conteudo-principal">
        ...
        <div className="hero-content"><p className="eyebrow">Exposição beneficente · Edição 2026</p><h1>Arte que atravessa<br />o tempo.</h1><p>Uma seleção singular de obras reunidas para contribuir financeiramente com a Basílica Santo Antônio.</p><div className="hero-actions"><a className="button primary" href="#acervo">Explorar o acervo <ArrowIcon /></a><a className="button ghost" href="#acervo">Conhecer o acervo</a></div></div>
        <a className="hero-scroll-cue" href="#acervo"><span>Descubra a coleção</span><i aria-hidden="true" /></a>
      </section>
